...
TEMPLATES = [
    {
        ...
        'DIRS': [ 'D:/Cultural__Code/Cultural_Expression/app_funcionalidad/templates/app_funcionalidad' , 'D:/Cultural__Code/Cultural_Expression/app_registro_olvido/templates/app_registro_olvido' , 'D:/Cultural__Code/Cultural_Expression/app_pag_static/templates/app_pag_static' ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
